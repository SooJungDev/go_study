...
func main() {
	...
	*/
	// 즉 , bufio 의 NewReader, NewWriter 를 통해서 객체 반환 후 메소드 사용
	// bufion(Bufferd io) 패키지
	...
	*/
	...
	file, err := os.OpenFile("/Users/crytal2840/go_study/src/section11/test_write2.txt", os.O_CREATE|os.O_RDWR, os.FileMode(0777))
